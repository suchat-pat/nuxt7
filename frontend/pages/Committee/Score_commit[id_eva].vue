    ...
    <v-container>
        <v-row>
            <v-col cols="12">
                        ...
                        <v-col cols="12">
                            ...
                            <v-table class="table">
                                ...
                                <tr v-for="indicate in topic.indicates" :key="indicate.id_indicate">
                                    ...
                                    <th class="text-center border pa-1">{{ indicate.score_commit*indicate.point_indicate }}</th>
                                </tr>
                            </v-table>
                        </v-col>
                    </v-row>
                ...
                <v-alert v-else-if="user.status_commit === 'n'" type="info">ยังไม่ได้ประเมิน</v-alert>
