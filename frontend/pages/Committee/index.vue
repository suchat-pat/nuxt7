                        ...
                        <v-table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border text-center">ตรวจสอบคะแนน</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_commit">
                                    ...
                                    <td class="border text-center"><v-btn class="text-white" size="small" color="blue" @click="go(items.id_eva)">ตรวจสอบ</v-btn></td>
                                </tr>
